...
class SendMessageBar: UIView {
    ...
    @IBOutlet weak var enablePeerButton: UIButton!
    // Overlays for peer messaging disabled and all writing diabled. Hidden by default.
    @IBOutlet weak var peerMessagingDisabledView: UIView!
